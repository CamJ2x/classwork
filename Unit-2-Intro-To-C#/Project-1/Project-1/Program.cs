// This is a comment - everything after the slash is ignored 
/*
 * THis is a block comment -  everything between the slash-asterisk
 *                              and asterisk-slash is ignored
 *
 * This is useful if you have a lot to say or you want to deactivate code
...
// A Class startes with the class keyword

class Program

//{} surround blocks of related code aka "code blocks"
{   // Every application has a method called Main()
    // a method is a self-contained set of code that preforms a function
    ...
    { 
        ...
        // A behavior is something a object can do with data
