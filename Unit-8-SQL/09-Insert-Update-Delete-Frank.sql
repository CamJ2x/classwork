...
--    - We Can ask the data base manager for a vlaue using a select
-- Use a sub-query/sub-select to have a data base manager fund the value
...
-- 			we can add to any dependent tables
